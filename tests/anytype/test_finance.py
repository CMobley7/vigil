...
from vigil.anytype.finance import build_finance_body, main
...
class TestMain:
    ...
    @patch("vigil.anytype.finance.ANYTYPE_API_KEY", "test-key")
    @patch("vigil.anytype.finance.AnytypeClient")
    def test_main_calls_update_object(
        ...
        with (
            patch("vigil.anytype.finance._STATE_FILE", state_file),
            patch("vigil.anytype.finance._FM_CACHE_FILE", fm_file),
        ):
            main()
    ...
    def test_main_exits_on_missing_state_file(self, tmp_path: Path) -> None:
        ...
        with (
            patch("vigil.anytype.finance._STATE_FILE", missing),
    ...
    @patch("vigil.anytype.finance.ANYTYPE_API_KEY", "")
