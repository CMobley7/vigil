...
class TestBuildBirthdayBody:
    ...
    @patch("vigil.anytype.birthdays.BIRTHDAY_USE_LLM", False)
...
class TestLlmBirthdayMessage:
    ...
    @patch("vigil.anytype.birthdays.OPENROUTER_API_KEY", "test-key")
    @patch("vigil.anytype.birthdays.BIRTHDAY_USE_LLM", True)
    @patch("vigil.anytype.birthdays.httpx.post")
    def test_successful_llm_response(self, mock_post: MagicMock) -> None:
        ...
        from vigil.anytype.birthdays import _call_sonnet_for_message
    ...
    @patch("vigil.anytype.birthdays.OPENROUTER_API_KEY", "test-key")
    @patch("vigil.anytype.birthdays.BIRTHDAY_USE_LLM", True)
    @patch("vigil.anytype.birthdays.httpx.post", side_effect=httpx.ConnectError("fail"))
    def test_llm_exception_falls_back_to_stub(self, mock_post: MagicMock) -> None:
        from vigil.anytype.birthdays import _draft_birthday_message
